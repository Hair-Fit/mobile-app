package com.examples.mycapstoneproject.ui.custom
...
class MyEditEmail: AppCompatEditText,OnTouchListener {
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (!s.toString().trim().isEmpty() && !s.toString().trim().isBlank() && Patterns.EMAIL_ADDRESS.matcher(s.toString().trim()).matches()) {
